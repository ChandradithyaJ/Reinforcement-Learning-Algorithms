...
def main():
    ...
    rewards_writer = FileWriter(outdir=results_folder, file_prefix="ALE-KungFuMaster-v5")

    # initialize hooks for logging
    iteration_num_hook = hooks.IterationNumHook(timing=100)
    iteration_state_hook = hooks.EvaluationHook(env, writer=rewards_writer, timing=100)
